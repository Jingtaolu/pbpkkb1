...
if "%1%"=="" goto StructureCheckerAlchemist
%JVMPATH% %JAVA_OPTS% -classpath %CLASSPATH% chemaxon.checkers.StructureCheck %*%

goto End

:StructureCheckerAlchemist
%JVMPATH% %JAVA_OPTS% -classpath %CLASSPATH% com.chemaxon.alchemist.structurechecker.StructureCheckerWizard
